          ...
          <div className="home_container section bd-grid">
            ...
            <div className="home_address bd-grid">
              <span className="home_information">
                <i className="bx bx-map " /> Jl. Minahasa 5, Kec. Kalawat, Kabupaten Minahasa Utara, Sulawesi Utara
              </span>
              <span className="home_information">
          ...
          <div className="skills_content bd-grid">
            <ul className="skills_data">
              <li className="skills_name">
                <span className="skills_circle" />HTML
              </li>
              <li className="skills_name">
                <span className="skills_circle" />CSS
              </li>
              <li className="skills_name">
                <span className="skills_circle" />Python
              </li>
              <li className="skills_name">
                <span className="skills_circle" />C#
              </li>
            </ul>
            <ul className="skills_data">
              <li className="skills_name">
                <span className="skills_circle" />Javascript
              </li>
              <li className="skills_name">
                <span className="skills_circle" />Git
              </li>
              <li className="skills_name">
                <span className="skills_circle" />C++
              </li>
          ...
          <div className="experience_container bd-grid">
            <div className="experience_content">
              ...
              <div className="experience_data bd-grid">
                ...
                <p className="experience_description">saya berhasil menyelesaikan hackerank</p>
              </div>
            </div>
            <div className="experience_content">
              <div className="experience_time">
              ...
              <div className="experience_data bd-grid">
                ...
                <span className="experience_company">From January-May</span>
                <p className="experience_description">saya berhasil menghafal pasa pasal</p>
              </div>
            </div>
          </div>
        </section>
        <section className="certificate section" id="certificate">
          ...
          <div className="certificate_container bd-grid">
            <div className="certificate_content">
              ...
              <p className="certificate_description">Successfully cleared the assessment for the skill JavaScript (Basic)</p>
            </div>
          </div>
        </section>
